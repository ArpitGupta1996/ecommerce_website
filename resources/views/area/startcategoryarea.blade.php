                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <div class="single-deal">
                            ...
                            <img class="img-fluid w-100" src="{{ asset('theme/img/category/c1.jpg') }}" alt="">
                            <a href="{{ asset('theme/img/category/c1.jpg') }}" class="img-pop-up" target="_blank">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="single-deal">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="{{ asset('theme/img/category/c2.jpg') }}" alt="">
