            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <div class="section-title">
                        ...
                        <p>Get the Latest Products here....Get the Latest Products here....Get the Latest Products
                            here....Get the Latest Products here....</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <a href="{{ url('productdetail') . '/' . $p->id }}">
                                <img class="img-fluid" src="{{ URL::to('products', $p->image) }}" alt="">
