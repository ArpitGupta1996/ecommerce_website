            ...
            <ul id="sidebarnav" class="p-t-30">
                    ...
                    <ul aria-expanded="false" class="collapse  first-level">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ url('admin/aboutus') }}" aria-expanded="false"><i
                                    class="mdi mdi-chart-bubble"></i><span class="hide-menu">About Company</span></a>
                        </li>
                        <li class="sidebar-item"><a href="{{ url('admin/author') }}" class="sidebar-link"><i
                                    class="mdi mdi-note-plus"></i><span class="hide-menu"> About Author </span></a></li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    ...
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item"><a href="{{ route('user.index') }}" class="sidebar-link"><i
                                    class="mdi mdi-note-plus"></i><span class="hide-menu">All User's </span></a></li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    ...
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item"><a href="{{ url('admin/productreview') }}" class="sidebar-link"><i
                                    class="mdi mdi-note-plus"></i><span class="hide-menu"> Product Reviews </span></a>
                        </li>
                    </ul>
                </li>
