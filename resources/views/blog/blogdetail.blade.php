                    ...
                    <div class="col-lg-8 posts-list">
                        <div class="single-post row">
                            ...
                            <div class="col-lg-3  col-md-3">
                                <div class="blog_info text-right">
                                    ...
                                    <ul class="blog_meta list">
                                        ...
                                        <li><a href="#">{{ date('d-m-Y', strtotime($d->created_at))}}<i class="lnr lnr-calendar-full"></i></a></li>
                            ...
                            {{-- <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <img class="img-fluid" src="{{ asset('theme/img/blog/post-img1.jpg') }}" alt="">
                                    </div>
                                    <div class="col-6">
                                        <img class="img-fluid" src="{{ asset('theme/img/blog/post-img2.jpg') }}" alt="">
                                    </div>
