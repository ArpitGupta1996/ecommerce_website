                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <div class="blog_details">
                                        @foreach ($blog as $b)
                                            <a href="{{ url('blog/blogdetail/' . $b->id) }}">
                                                <img src="{{ URL::to('images/blog/' . $b->image) }}" alt="image"
                                                    width="30%" height="30%">

                                                <h2>{{ $b->title }}</h2>
                                                <p>{!! substr(strip_tags($b->body), 0, 20) !!}.....</p>
                                            </a>
                                        @endforeach
                                    </div>
                                </div>
                    ...
                    <div class="blog_right_sidebar">
                        <aside class="single_sidebar_widget search_widget">
                            <div class="input-group">
                                ...
                                <form action="{{ route('blog.search') }}" method="GET" class="input-group">
                                    <input type="text" class="form-control" placeholder="Search Posts"
                                        onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search Posts'"
                                        name="search">
                                    <span class="input-group-btn">
